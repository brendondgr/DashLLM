...
class SignupRequest(BaseModel):
    ...
    # 12 chars minimum: these accounts hold a proxy key to real hardware.
...
class ApiKeyOut(BaseModel):
    """The cleartext key is returned exactly once, at creation or rotation —
    only its SHA-256 is stored, so it cannot be shown again."""
    api_key: str
    api_key_prefix: str
